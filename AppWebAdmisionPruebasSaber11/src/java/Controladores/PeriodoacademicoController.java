...
import Beans.PeriodoacademicoFacade;
...
public class PeriodoacademicoController implements Serializable {
    ...
    @EJB
    private Beans.PeriodoacademicoFacade ejbFacade;
    ...
    public Periodoacademico getPeriodoacademico(java.math.BigDecimal id) {
    ...
    public static class PeriodoacademicoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPeriodoacademico(getKey(value));
        }
